"""Exercise 05 — Force the model to emit JSON matching a schema.
...
screen. 06 graduates the schema into its own file and adds nested
...
# 06 uses descriptions throughout — compare the two and you'll feel the
# difference.
SCHEMA = {
