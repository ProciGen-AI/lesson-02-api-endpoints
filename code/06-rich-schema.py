"""Exercise 06 — Scale the schema up to something production-grade.

Diff against 05-structured-output.py: same tool-forced Converse call, same
...
Still no validation here — we add that in 07. For now, trust the model
